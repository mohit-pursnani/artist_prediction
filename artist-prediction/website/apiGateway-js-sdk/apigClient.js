...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://32wixjqn85.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.predictGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['q'], ['body']);
        
        var predictGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/predict').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(predictGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.predictOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var predictOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(predictOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.uploadBucketFilenamePut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'bucket', 'x-amz-meta-customlabels', 'x-amz-meta-price', 'x-amz-meta-artistname', 'accept', 'x-amz-meta-description', 'content-type'], ['body']);
        ...
        var uploadBucketFilenamePutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['x-amz-meta-customlabels', 'x-amz-meta-price', 'x-amz-meta-artistname', 'accept', 'x-amz-meta-description', 'content-type']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
    ...
    apigClient.uploadBucketFilenameOptions = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['x-amz-meta-customlabels', 'x-amz-meta-price', 'x-amz-meta-artistname', 'accept', 'x-amz-meta-description'], ['body']);
        ...
        var uploadBucketFilenameOptionsRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['x-amz-meta-customlabels', 'x-amz-meta-price', 'x-amz-meta-artistname', 'accept', 'x-amz-meta-description']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
